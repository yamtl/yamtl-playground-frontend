...
# Functions for running EMF 
#cd com.mde-network.ep.toolfunctions.%
#mvn -B -o function:run -Drun.functionTarget=com.mdenetnetwork.ep.toolfunctions.% -Drun.port=8001 &
